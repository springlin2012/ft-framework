...
public class IdWorker {
     ...
     * (a) id构成: 42位的时间前缀 + 10位的节点标识 + 12位的sequence避免并发的数字(12位不够用时强制得到新的时间前缀),一共生成18字节ID
    ...
    public static IdWorker getFlowIdWorkerInstance(long workerId) {
        return flowIdWorker = new IdWorker(workerId);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        IdWorker idWorker = IdWorker.getFlowIdWorkerInstance(3);
