...
import com.ft.framework.security.sdk.security.MSecurityHelper;
import com.ft.framework.security.sdk.security.SecurityHelper;
...
//            decodeDemo(securityHelper);
            ...
            // platform encode
            responseDecodeDemo(securityHelper);
            // merchant decode
//            responseDecodeDemo(mSecurityHelper);
        } catch (Exception e) {
            e.printStackTrace();
        }
